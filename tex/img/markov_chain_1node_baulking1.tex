...
\begin{tikzpicture}
    ...
    \draw[draw=red] (1) edge[out=45,in=135,->,thick] node [below, text=red] {\tiny$\Lambda \frac{n}{n+1}$}  (2);
    \draw[draw=red] (2) edge[out=45,in=180,->,thick] node [below, text=red] {\tiny$\Lambda \frac{n-1}{n+1}$}  ($(2)+(1.5,0.7)$);
    \draw[draw=red] ($(n-1)+(-1.5,0.7)$) edge[out=0,in=135,->,thick] node [below, text=red] {\tiny$\Lambda \frac{3}{n+1}$}  (n-1);
    \draw[draw=red] (n-1) edge[out=45,in=135,->,thick] node [below, text=red] {\tiny$\Lambda \frac{2}{n+1}$}  (n);
    \draw[draw=red] (n) edge[out=45,in=135,->,thick] node [below, text=red] {\tiny$\Lambda \frac{1}{n+1}$}  (n+1);
